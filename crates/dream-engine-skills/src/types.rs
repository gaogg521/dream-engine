...
// Re-export EffortLevel from dream-types (single source of truth)
pub use dream_engine_types::skill_types::EffortLevel;
...
pub enum SkillSource {
    /// `<config_dir>/dream/skills/`
    User,
    /// .dream/skills/ (project-level)
    Project,
    /// .dream/.managed/skills/
    Managed,
    /// Built-in bundled skills
    Bundled,
    /// Loaded via MCP protocol
    Mcp,
    /// .dream/commands/ (legacy compatibility)
    Legacy,
}
