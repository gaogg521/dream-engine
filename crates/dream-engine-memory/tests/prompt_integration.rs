...
use dream_engine_memory::prompt::{build_memory_instructions, build_memory_prompt, memory_type_descriptions};
...
// ---------------------------------------------------------------------------
// TC-6.6: Paths use dream brand, not hardcoded platform paths
// ---------------------------------------------------------------------------
