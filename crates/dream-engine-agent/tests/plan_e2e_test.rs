...
use dream_engine_agent::plan::prompt::plan_mode_instructions;
...
use dream_engine_types::skill_types::PlanModeTransition;
...
fn tc_3_6_e2e_02_plan_mode_and_compaction_independent() {
    use dream_engine_agent::compact::micro::microcompact;
    use dream_engine_agent::plan::state::PlanState;
