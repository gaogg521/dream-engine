...
mod tests {
    ...
    use dream_engine_skills::types::{ExecutionContext, LoadedFrom, SkillSource};
    use serde_json::json;
...
mod supplemental_tests {
    ...
    use dream_engine_skills::permissions::SkillPermissionChecker;
    use dream_engine_skills::types::{ExecutionContext, LoadedFrom, SkillMetadata, SkillSource};
    ...
    async fn tc_13_8_full_variable_substitution_integration() {
        let mut skill = make_skill("my-skill", "Run ${DREAM_SKILL_DIR}/tool.sh $ARGUMENTS[0]");
...
mod supplemental_tests_p6 {
    ...
    use dream_engine_skills::permissions::SkillPermissionChecker;
    use dream_engine_skills::types::{EffortLevel, ExecutionContext, LoadedFrom, SkillMetadata, SkillSource};
    use dream_engine_tools::Tool;
