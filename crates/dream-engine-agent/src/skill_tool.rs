...
use dream_engine_skills::context_modifier::ContextModifier;
use dream_engine_skills::executor::{execute_fork, prepare_inline_content};
use dream_engine_skills::hooks::{parse_skill_hooks, to_hook_defs};
use dream_engine_skills::permissions::{SkillPermission, SkillPermissionChecker};
use dream_engine_skills::types::{ExecutionContext, SkillMetadata};
...
pub struct SkillTool {
    ...
    /// Session ID passed to prepare_inline_content for ${DREAM_SESSION_ID} substitution.
...
impl Tool for SkillTool {
    ...
    fn context_modifier_for(&self, input: &serde_json::Value) -> Option<ContextModifier> {
        ...
        dream_engine_skills::context_modifier::from_skill(skill)
    }
