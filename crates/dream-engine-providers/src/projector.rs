use dream_engine_config::compat::{self, ProviderCompat, ToolWireShape};
use dream_engine_config::schema::legalize_json_schema;
use dream_engine_types::llm::{LlmRequest, ThinkingConfig};
use dream_engine_types::tool::{ToolDef, truncate_deferred_description};
