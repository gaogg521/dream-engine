...
use dream::confirm::ToolConfirmer;
use dream::protocol::events::ToolCategory;
use dream::config::{Config, ProviderType, ToolsConfig, SessionConfig};
use dream::hooks::HooksConfig;
use dream::mcp::config::McpConfig;
use dream::provider::{LlmProvider, ProviderError};
use dream::tools::Tool;
use dream::types::llm::{LlmEvent, LlmRequest};
use dream::types::message::{StopReason, TokenUsage};
use dream::types::tool::ToolResult;
...
pub fn test_config() -> Config {
    Config {
        ...
        compat: dream::provider::compat::ProviderCompat::anthropic_defaults(),
        tools: ToolsConfig {
            auto_approve: true,
            allow_list: vec![],
            skills: dream::config::SkillsPermissionConfig::default(),
        },
        session: SessionConfig {
            enabled: false,
            directory: "/tmp/dream-test-sessions".to_string(),
            max_sessions: 5,
        },
        compact: dream::config::CompactConfig::default(),
        plan: dream::config::PlanConfig::default(),
